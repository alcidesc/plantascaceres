    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active'      => ['admin/facturacion', 'admin/facturacion*', 'regex:@^content/[0-9]+$@'],
        ],
        [
            'text'        => 'Lista de Facturas',
            'url'         => 'admin/listafacturas',
            'icon'        => 'fas fa-clipboard-list',
            'active'      => ['admin/listafacturas', 'admin/listafacturas*', 'regex:@^content/[0-9]+$@'],
        ],
        [
            'header' => 'PRODUCTOS',
        ],
        ...
        [
            'text'        => 'Extracciones',
            'url'         => 'admin/fecha-extraccion',
            'icon'        => 'fas fa-money-check-alt',
            'active'      => ['admin/fecha-extraccion', 'admin/fecha-extraccion*', 'regex:@^content/[0-9]+$@'],
        ],
        [
            'text'        => 'Depositos',
            'url'         => 'admin/fecha-deposito',
            'icon'        => 'fas fa-money-check-alt',
            'active'      => ['admin/fecha-deposito', 'admin/fecha-deposito*', 'regex:@^content/[0-9]+$@'],
        ],
        [
            'header' => 'CLIENTES',
        ],
