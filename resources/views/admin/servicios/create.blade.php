    ...
    {{Form::token()}}
        <div class="card">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group" align="center">
                            <label>Foto muestra del Servicio:</label><br>
                            <output id="list">
                ...
                <div class="row">
                    <div class="col-md-6"><br>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="precio" value="{{ old('precio') }}" name="precio" class="number form-control @error('precio') is-invalid @enderror" placeholder="Precio de venta">
                            @error('precio')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6"><br>
                        <label>Precio oferta del servicio:</label>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-money-bill-wave"></i></span>
                            </div>
                            <input type="text" id="oferta" value="{{ old('oferta') }}" name="oferta" class="number form-control @error('oferta') is-invalid @enderror" placeholder="Precio de oferta">
                            @error('oferta')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
            ...
            <div class="card-footer" align="center">
                <button type="submit" class="btn btn-info"><i class="fas fa-save"></i> Crear Servicio</button>
            </div>
        </div>
    {!!Form::close()!!}
    <script>
